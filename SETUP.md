...
- **Wrong callback URL in Google Console** – Add `http://localhost:3000/auth/google/callback` (local) and `https://connectx.online/auth/google/callback` (production) as authorized redirect URIs.
